...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <form action="{{ route('admin.productos.update', $producto) }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                <input type="number" id="precio" name="precio" value="{{ old('precio', $producto->precio) }}" min="0" step="1"
            ...
            <div>
                ...
                <input type="number" id="stock" name="stock" value="{{ old('stock', $producto->stock ?? 0) }}" min="0" step="1"
            ...
            <div>
                ...
                @if($producto->imagen)
                    <div class="mb-4">
                        ...
                        <img src="{{ asset('images/productos/' . $producto->imagen) }}" alt="{{ $producto->nombre }}" class="h-32 object-cover rounded-lg border border-gray-200">
                    </div>
                @endif
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center cursor-pointer hover:border-orange-500 transition-colors" id="upload-area">
                    ...
                    <p class="text-gray-600 font-semibold">Arrastra una imagen aquí o haz clic para cambiar</p>
